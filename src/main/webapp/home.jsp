...
<html>
	...
	<body>
		...
		<p>
			...
			<shiro:guest>
				<a href="<c:url value="/login.jsp"/>">Log in</a> (sample accounts provided)</shiro:guest>
			)
		</p>
		...
		<shiro:user>
			<p>
				...
				<a href="<c:url value="/account/admin.jsp"/>">admin page</a>.
				<a href="<c:url value="/account/changepwd.jsp"/>">change
					password page</a>.
			</p>
		</shiro:user>
		<shiro:guest>
			<p>
				If you want to access the user-only
				<a href="<c:url value="/account"/>">account page</a>, you will need
				to log-in first.
			</p>
		</shiro:guest>
		...
		<p>
			To show some taglibs, here are the roles you have and don't have. Log
			out and log back in under different user accounts to see different
			roles.
		</p>
		...
		<p>
			<shiro:hasPermission name="users">users<br />
			</shiro:hasPermission>
			<shiro:hasPermission name="admin:changepwd">admin:changepwd<br />
			</shiro:hasPermission>
			<shiro:hasPermission name="admin:deluser">admin:deluser<br />
			</shiro:hasPermission>
		</p>
